...
exports.addDarie = exports.getEntriesWithoutSensitiveInfo = exports.findById = exports.getEntries = void 0;
...
const addDarie = (nweDiaryEntry) => {
    const nweDiary = Object.assign({ id: Math.max(...diaries.map(d => d.id)) + 1 }, nweDiaryEntry);
    diaries.push(nweDiary);
    return nweDiary;
};
exports.addDarie = addDarie;
